...
import { Play, Calendar, Dumbbell, Users, TrendingDown } from 'lucide-react';
import { VIDEOS as allVideos } from '../data/mock.js';

export default function Hero() {
 const [status] = useState({ isLive: false, nextScheduled: null });
 
 // Featured video - prioritize BJJ/OpenClaw content
 ...
 { icon: TrendingDown, name: 'Transformation', description: '242 → 188 lbs. Real numbers, documented progress.', href: '/start-here' }
 ];
 ...
 <a href="/start-here" className="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-full transition-all hover:scale-105 flex items-center gap-2 shadow-lg shadow-blue-900/50">
 <Play size={20} fill="currentColor" /> Start Here
 </a>
 <a href="/videos" className="px-8 py-3.5 bg-neutral-900 hover:bg-neutral-800 text-white border border-neutral-800 rounded-full transition-all hover:border-neutral-600 font-medium">
 Browse Videos
 </a>
 </div>
 </div>
