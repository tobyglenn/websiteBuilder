  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-8">
        <a href="/podcasts/agentstack/" className="inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-white transition-colors group">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-6">
              ...
              <PodcastSubscribeButtons
                ...
                rssUrl={rssUrl}
                youtubeUrl="https://www.youtube.com/@AgentStackDaily"
              />
            </div>
          </div>
        </div>
