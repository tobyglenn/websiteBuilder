...
export default function Header() {
 ...
 <a
 href="/"
 className="text-xl font-bold tracking-tight bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent hover:opacity-80 transition-opacity"
 >
 TobyOnFitnessTech
 </a>
 ...
 link.highlight
 ? 'text-white font-semibold hover:text-blue-400 flex items-center'
 : 'text-neutral-300 hover:text-white'
 }`}
 >
 {link.name}
 {link.highlight && (
 <span className="ml-1.5 inline-block w-2 h-2 bg-blue-500 rounded-full"></span>
 )}
 </a>
 ))}
 </nav>
 ...
 <button
 type="submit"
 className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 group-hover:text-white"
 >
 <Search size={16} />
 </button>
 </form>
