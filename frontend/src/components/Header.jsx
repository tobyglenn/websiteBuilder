...
const NAV_TRANSLATIONS = {
  en: {
    ...
    gear: 'Gear', contact: 'Contact', hrZones: 'HR Zones', podcasts: 'Podcasts', openclaw: 'AgentStack Daily', fitness: 'Fitness Tech Podcast', onePeter: '1 Peter',
  },
  de: {
    ...
    gear: 'Ausrüstung', contact: 'Kontakt', hrZones: 'HF-Zonen', podcasts: 'Podcasts', openclaw: 'AgentStack Daily', fitness: 'Fitness-Tech-Podcast', onePeter: '1 Petrus',
  },
  es: {
    ...
    gear: 'Equipo', contact: 'Contacto', hrZones: 'Zonas FC', podcasts: 'Podcasts', openclaw: 'AgentStack Daily', fitness: 'Podcast Fitness Tech', onePeter: '1 Pedro',
  },
  pt: {
    ...
    gear: 'Equipamento', contact: 'Contato', hrZones: 'Zonas FC', podcasts: 'Podcasts', openclaw: 'AgentStack Daily', fitness: 'Podcast Fitness Tech', onePeter: '1 Pedro',
  },
  hi: {
    ...
    gear: 'गियर', contact: 'संपर्क', hrZones: 'HR ज़ोन', podcasts: 'पॉडकास्ट', openclaw: 'AgentStack Daily', fitness: 'फिटनेस टेक पॉडकास्ट', onePeter: '1 पतरस',
  },
};
...
export default function Header() {
  ...
  const navLinks = useMemo(() => ([
    ...
    { name: t.onePeter, href: localizedHref(locale, '/one-peter-memory/'), icon: '📖' },
