...
export const projectGroups: { id: string; eyebrow: string; title: string; description: string; projects: Project[] }[] = [
  {
    ...
    projects: [{
      ...
      heroImage: {
        ...
        alt: 'Connected physical device running automated Pokémon GO friend inspection and gift routines',
        caption: 'Live physical device running automated friend inspection, gift sending, and status logging via ADB.',
        aspect: 'portrait',
      },
      gallery: [
        {
          src: '/images/projects/pokemon-go-automation/gift_sent.png',
          alt: 'Sub-pixel gift delivery confirmation dialog',
          title: 'Verified Gift Delivery',
          description: 'Automated sub-pixel confirmation verifying that a postcard gift was dispatched before advancing to the next trainer.',
        },
        {
          src: '/images/projects/pokemon-go-automation/gift_picker.png',
          alt: 'In-game gift inventory selection',
          title: 'Inventory Traversal',
          description: 'Dynamic screen-region template matching to select available gifts without manual interaction.',
        },
        {
          src: '/images/projects/pokemon-go-automation/friend_tapped.png',
          alt: 'Friend interaction state detection',
          title: 'Friend State Detection',
          description: 'Fast optical character recognition and color thresholding to detect interaction eligibility and friendship level.',
        },
      ],
      overview: [
