...
- `outbound_click`: visitor leaves through an external link, including ordinary product references and podcast destinations not captured by a more specific event.
...
- External product and partner outbound clicks.
